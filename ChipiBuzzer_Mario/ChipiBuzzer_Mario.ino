/*********************************************************************************
 * //  Chương trình: ChipiBuzzer_Mario
 * //  Tác giả: TP, có tham  khảo và cảm ơn tới Dipto Pratyaksa
 * //  Ngày: 25 Oct 2014
 * //  Mô tả: Chương trình này sẽ kêu loa bíp được nối với Arduino ở chân số 8 thành bản nhạc Mario
...
void setup()
{
  ...
  pinMode(13,OUTPUT);  //Nháy led mỗi khi chơi nhạc
}
